...
router.patch("/:id", isRoleAuthorizedMiddleware(["family"]), verifyFamily(), upload.single("profile_photo"), validate(patchSchema, "body"), withTryCatch(familyController.patchFamily));
